...
// Example usage:
const ticket1 = new Ticket(['item1', 'item2'], '2023-01-01 12:00:00', 'customer123');
...
// Call the updateStatus method on firstTicket
...
console.log(`Initial status of the order for customer ${firstTicket.customerId}: ${firstTicket.status}`);
